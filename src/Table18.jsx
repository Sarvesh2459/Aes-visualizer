  ...
  return (
      ...
      <table  className='tablekliye' style={{backgroundColor:"black",color:"white"}}>
        ...
        <tr  >
          ...
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=33 ? 'col-show': 'col-hide'}>{arr[8]}{arr[9]}</th>
          <th style={{color:"white"}} className={flag>=41 ? 'col-show': 'col-hide'}>{arr[16]}{arr[17]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=49 ? 'col-show': 'col-hide'}>{arr[24]}{arr[25]}</th>
        </tr>
        <tr>
          <th style={{color:"white"}} className={flag>=9 ? 'col-show': 'col-hide'}>{arr[2]}{arr[3]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=35 ? 'col-show': 'col-hide'}>{arr[10]}{arr[11]}</th>
          <th style={{color:"white"}} className={flag>=43 ? 'col-show': 'col-hide'}>{arr[18]}{arr[19]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=51 ? 'col-show': 'col-hide'}>{arr[26]}{arr[27]}</th>
        </tr>
        <tr>
          <th style={{color:"white"}} className={flag>=17 ? 'col-show': 'col-hide'}>{arr[4]}{arr[5]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=37 ? 'col-show': 'col-hide'}>{arr[12]}{arr[13]}</th>
          <th style={{color:"white"}} className={flag>=45 ? 'col-show': 'col-hide'}>{arr[20]}{arr[21]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=53 ? 'col-show': 'col-hide'}>{arr[28]}{arr[29]}</th>
        </tr>
        <tr>
          <th style={{color:"white"}} className={flag>=25 ? 'col-show': 'col-hide'}>{arr[6]}{arr[7]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=39 ? 'col-show': 'col-hide'}>{arr[14]}{arr[15]}</th>
          <th style={{color:"white"}} className={flag>=47 ? 'col-show': 'col-hide'}>{arr[22]}{arr[23]}</th>
          <th style={{color:"rgb(27, 191, 32)"}} className={flag>=55 ? 'col-show': 'col-hide'}>{arr[30]}{arr[31]}</th>
        </tr>     
