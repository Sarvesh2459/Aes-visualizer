...
function Table16(prop) {
  ...
  return (
      <table  className='tablekliye'>
        ...
        {(flag>=49 && flag<=50) ?<th style={{color:"white", fontSize: "large", border: "5px solid white",zIndex:"500"}}>{arr[26]}{arr[27]}</th>: <th>{arr[26]}{arr[27]}</th>}
        </tr>
        <tr>
        ...
        {(flag>=51 && flag<=52) ?<th style={{color:"white", fontSize: "large", border: "5px solid white",zIndex:"500"}}>{arr[28]}{arr[29]}</th>: <th>{arr[28]}{arr[29]}</th>}
        </tr>
        <tr>
        ...
        {(flag>=53 && flag<=54) ?<th style={{color:"white", fontSize: "large", border: "5px solid white",zIndex:"500"}}>{arr[30]}{arr[31]}</th>: <th>{arr[30]}{arr[31]}</th>}
        </tr>
        <tr>
        ...
        {(flag>=55 && flag<=56) ?<th style={{color:"white", fontSize: "large", border: "5px solid white",zIndex:"500"}}>{arr[24]}{arr[25]}</th>: <th>{arr[24]}{arr[25]}</th>}
        </tr>     
